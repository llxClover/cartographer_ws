...
bool operator==(const ::cartographer_ros_msgs::StartTrajectoryRequest_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::StartTrajectoryRequest_<ContainerAllocator2> & rhs)
{
