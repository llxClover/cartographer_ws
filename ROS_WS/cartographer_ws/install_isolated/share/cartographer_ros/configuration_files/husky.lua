...
options = {
  ...
  odom_frame = "odom",
  provide_odom_frame = false,     #是否发布odom，用于carto和实际机器人的tf_tree连接
  publish_frame_projected_to_2d = false,
  use_odometry = false,
  use_nav_sat = false,
  use_landmarks = false,
  num_laser_scans = 0,   #单线激光雷达的数量
  num_multi_echo_laser_scans = 0,
  num_subdivisions_per_laser_scan = 1,
  num_point_clouds = 1, #多线激光雷达，是否使用点云数据
...
TRAJECTORY_BUILDER_2D.max_range = 80. -- Decrease
