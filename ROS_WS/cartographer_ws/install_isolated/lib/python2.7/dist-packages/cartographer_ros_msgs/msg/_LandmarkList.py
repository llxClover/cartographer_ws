...
"""autogenerated by genpy from cartographer_ros_msgs/LandmarkList.msg. Do not edit."""
import codecs
import sys
...
class LandmarkList(genpy.Message):
  _md5sum = "301d0343edf9ac469d5bbb0142518bf8"
  _type = "cartographer_ros_msgs/LandmarkList"
    ...
    try:
      ...
      for val1 in self.landmark:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v1 = val1.tracking_from_landmark_transform
        _v2 = _v1.position
        _x = _v2
        ...
        _x = val1
        buff.write(_get_struct_2d().pack(_x.translation_weight, _x.rotation_weight))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v4 = val1.tracking_from_landmark_transform
        _v5 = _v4.position
        _x = _v5
        start = end
        end += 24
        ...
        (_x.translation_weight, _x.rotation_weight,) = _get_struct_2d().unpack(str[start:end])
    ...
    try:
      ...
      for val1 in self.landmark:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
        _v7 = val1.tracking_from_landmark_transform
        _v8 = _v7.position
        _x = _v8
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        _v9 = _v7.orientation
